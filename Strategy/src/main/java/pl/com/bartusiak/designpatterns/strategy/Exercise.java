package pl.com.bartusiak.designpatterns.strategy;
...
class QuadraticEquationSolver
{
    ...
    public Pair<Complex, Complex> solve(double a, double b, double c)
    {
        ...
        Complex A = new Complex(2*a,0);
        Complex B = new Complex(-b, 0);
        Complex DELTA = Complex.sqrt(delta);

        Complex c1 = B.plus(DELTA).divides(A);
        Complex c2 = B.minus(DELTA).divides(A);
...
public class Exercise {
    public static void main(String[] args) {
        QuadraticEquationSolver quadraticEquationSolver = new QuadraticEquationSolver(new RealDiscriminantStrategy());
        Pair<Complex, Complex> solve = quadraticEquationSolver.solve(4, 1, 4);
